...
help_embed.add_field(name='What do I do?', value="I keep your server a nice, positive place where you and your friends can hang out. Check out the project at https://github.com/CuteBlueRadio/Joyous")
